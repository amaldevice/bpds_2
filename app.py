...
def predict(data, model):
    ...
    return y_pred[0]  # Return the first prediction
...
# Create feature input categories
with st.sidebar:
    with st.expander("Personal Information", expanded=True):
        ...
        marital_status = st.selectbox(
            "Marital Status", 
            options=[(1, "Single"), (2, "Married"), (3, "Widower"), (4, "Divorced"), (5, "Facto union"), (6, "Legally separated")],
...
if predict_button:
    ...
    with st.spinner("Generating prediction..."):
        try:
            ...
            # Additional information based on outcome
            if prediction == 0:
...
# Footer
st.markdown("---")
st.markdown("Built with ❤️ using Streamlit and LightGBM")
